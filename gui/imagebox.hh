...
class ImageBox
{
    public:
        ...
        bool Connect();
        bool SendCommand(int sockfd, comm_status_t type, uint8_t *data, int32_t size);
        bool ProcessMessage(const LolMessage* msg);
        ...
        static void Monitoring(LolMessage *msg, void *ptr);
};
