    ...
    Fl_Overlay_Window(w,h,"Canvas")
{
    ...
    displays.push_back(new iDisplay(this,startx+gapx+320, starty));
    displays.push_back(new iDisplay(this,startx, starty+gapy+240));
 //   displays.push_back(new iDisplay(this,startx+gapx+320, starty+gapy+240));
