...
#define ADCS_4_CHAN	(int)(2.0*FCY/(MIC_SAMP_FREQ*(14+1)*4)-1)
#define ADCS_5_CHAN	(int)(2.0*FCY/(MIC_SAMP_FREQ*(14+1)*5)-1)	// 
#define ADCS_6_CHAN	(int)(2.0*FCY/(MIC_SAMP_FREQ*(14+1)*6)-1)	//
#define ADCS_7_CHAN	(int)(2.0*FCY/(MIC_SAMP_FREQ*(14+1)*7)-1) 
#define ADCS_8_CHAN	(int)(2.0*FCY/(MIC_SAMP_FREQ*(14+1)*8)-1) 
#define ADCS_9_CHAN	(int)(2.0*FCY/(MIC_SAMP_FREQ*(14+1)*9)-1) 
...
#define BATT_SAMP_NB 30 // number of battery voltage samples to store
