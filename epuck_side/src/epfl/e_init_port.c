...
/********************** INPUTS **************************/
	...
	/* selector*/
  	SPI_PCK_DIR = INPUT_PIN;
  	SPI_SDI_DIR = INPUT_PIN;
  	SPI_SDO_DIR = OUTPUT_PIN;
  	SPI_CS_DIR   =INPUT_PIN;
	
	/*camera*/
	//CAM_y0_DIR = OUTPUT_PIN;
	//CAM_y1_DIR = OUTPUT_PIN;
	//CAM_y2_DIR = OUTPUT_PIN;
	//CAM_y3_DIR = OUTPUT_PIN;
	//CAM_y4_DIR = OUTPUT_PIN;
	//CAM_y5_DIR = OUTPUT_PIN;
	//CAM_y6_DIR = OUTPUT_PIN;
	//CAM_y7_DIR = OUTPUT_PIN;	
}
